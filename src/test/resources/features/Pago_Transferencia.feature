Feature: Yo como usuario pagador
  Quiero realizar una transaccion a un comercio en modo sandbox por medio de Transferencia
  ...
  Scenario Outline: Se verifica el resultado aprobado luego de que un usuario realiza el proceso de pago por Transferencia
    ...
    And el usuario ingresa informacion bancaria requerida
      | tipotransaccion   |
      | <tipotransaccion> |
    Then el usuario vera el siguiente mensaje: Transacción aprobada (Transferencia Bancolombia)

    Examples:
      | valormonto | correo               | nombresyapellidos            | cel        | tipotransaccion      |
      | 500000     | notengo@gmail.com.co | Andres Alfonso Zapata Suarez | 3115254558 | Transacción APROBADA |
  ...
  Scenario Outline: Se verifica el resultado declinado luego de que un usuario realiza el proceso de pago por pse
    ...
    And el usuario ingresa informacion bancaria requerida
      | tipotransaccion   |
      | <tipotransaccion> |
    Then el usuario vera el siguiente mensaje: Transacción declinada (Transferencia Bancolombia)
  ...
  Scenario Outline: Se verifica el resultado error luego de que un usuario realiza el proceso de pago por pse
    ...
    And el usuario ingresa informacion bancaria requerida
      | tipotransaccion   |
      | <tipotransaccion> |
    Then el usuario vera el siguiente mensaje de error: Transacción con error (Transferencia Bancolombia)
